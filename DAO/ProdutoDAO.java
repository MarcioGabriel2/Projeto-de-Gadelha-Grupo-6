...
public class ProdutoDAO {
    ...
    public void salvar(Produto p) {
        String sql = "INSERT INTO produtos (marca, codigo_barras, preco, quantidade_estoque, tipo_id) VALUES (?, ?, ?, ?, ?)";
    ...
    public List<Produto> listarTodos() {
        ...
        String sql = "SELECT p.*, t.nome as tipo_nome, t.forma_venda FROM produtos p INNER JOIN tipos t ON p.tipo_id = t.id";
