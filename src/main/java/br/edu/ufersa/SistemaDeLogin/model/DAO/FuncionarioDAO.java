...
public class FuncionarioDAO {
    ...
    // NOVO: Busca apenas 1 funcionário direto no banco de dados para o login
    ...
    // NOVO: Verifica rapidamente se o nome já existe sem baixar a tabela toda
    ...
    // Atualiza a senha baseada no nome/email do funcionário
    public void atualizarSenha(String nome, String novaSenha) {
        ...
        try (Connection con = Conexao.getConnection();
            ...
            if (linhasAfetadas == 0) {
                // Se for 0, significa que não existe ninguém com esse email no banco
